...
const nombre = parseInt(prompt("entrez un nombre alatoires"))
if (nombre>0){
...
if (hello === "Bonjour"){
    ...
    console.log("tu me dis même pas Boujour mal polis")
}
...
const numberValues = parseInt(prompt("entrez un nombre alatoires"))
if (numberValues>0){
    console.log(`${numberValues} est positif`)
}else {
    console.log(`${numberValues} est négatif ou nul`)
}
...
if (civilStatus === "married"){
    console.log(`${firstName} est ${civilStatus} !`)
}else {
...
if (bmiMark > bmiJohn){
    ...
    console.log(`"Le BMI de John ${bmiJohn} est plus élevé que celui de Mark ${bmiMark}`);

}
// Écrire un programme qui teste si un nombre entré par l’utilisateur est pair ou impair.
const numberType = parseInt(prompt("entrez un nombre"));
if (numberType%2 === 0){
    console.log(`${numberType} est paire`);
}else {
    console.log(`${numberType} est impaire`);
